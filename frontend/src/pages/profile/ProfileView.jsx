                    ...
                    {user?.email && (
                      <div className="flex items-center gap-3 text-text-secondary">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs sm:text-sm text-text break-all">{user.email}</div>
                        </div>
                      </div>
                    )}
                    ...
                    {user?.phone && (
                      <div className="flex items-center gap-3 text-text-secondary">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs sm:text-sm text-text">{user.phone}</div>
                        </div>
                      </div>
                    )}
                    ...
                    {user?.country && user.country !== "Not specified" && (
                      <div className="flex items-center gap-3 text-text-secondary">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs sm:text-sm text-text">{user.country}</div>
                        </div>
                      </div>
                    )}
                  ...
                  {user?.email && (
                    <div className="flex items-center gap-3 text-text-secondary">
                      <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="min-w-0 flex-1">
                        <div className="text-xs text-text-secondary">Email</div>
                          <div className="text-sm text-text break-all">{user.email}</div>
                        </div>
                    </div>
                  )}
          ...
          {/* Tab Content */}
            ...
            {activeTab === 'posts' && (
                <div className="text-center py-10 sm:py-12">
                  ...
                  <p className="text-text-secondary text-sm sm:text-base">No posts yet</p>
              </div>
            )}
